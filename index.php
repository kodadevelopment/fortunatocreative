...
<title>Fortunato Creative - Package Design & Package Visualizations</title>
<?php wp_head(); ?>
</head>
...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="#">fortunato creative</a>
